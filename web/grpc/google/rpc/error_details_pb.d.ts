...
export class DebugInfo extends jspb.Message {
  ...
  clearStackEntriesList(): DebugInfo;
  addStackEntries(value: string, index?: number): DebugInfo;
...
export class QuotaFailure extends jspb.Message {
  ...
  clearViolationsList(): QuotaFailure;
...
export class PreconditionFailure extends jspb.Message {
  ...
  clearViolationsList(): PreconditionFailure;
...
export class BadRequest extends jspb.Message {
  ...
  clearFieldViolationsList(): BadRequest;
