...
export class Constraint extends Message<Constraint> {
  ...
  static equals(a: Constraint | PlainMessage<Constraint> | undefined, b: Constraint | PlainMessage<Constraint> | undefined): boolean {
    return proto2.util.equals(Constraint, a, b);
  }
}
...
export class MessageConstraints extends Message<MessageConstraints> {
  ...
  static equals(a: MessageConstraints | PlainMessage<MessageConstraints> | undefined, b: MessageConstraints | PlainMessage<MessageConstraints> | undefined): boolean {
    return proto2.util.equals(MessageConstraints, a, b);
  }
}
...
export class OneofConstraints extends Message<OneofConstraints> {
  ...
  static equals(a: OneofConstraints | PlainMessage<OneofConstraints> | undefined, b: OneofConstraints | PlainMessage<OneofConstraints> | undefined): boolean {
    return proto2.util.equals(OneofConstraints, a, b);
  }
}
...
export class FieldConstraints extends Message<FieldConstraints> {
  ...
  static equals(a: FieldConstraints | PlainMessage<FieldConstraints> | undefined, b: FieldConstraints | PlainMessage<FieldConstraints> | undefined): boolean {
    return proto2.util.equals(FieldConstraints, a, b);
  }
}
 ...
 */
export class PredefinedConstraints extends Message<PredefinedConstraints> {
  /**
   * `cel` is a repeated field used to represent a textual expression
   * in the Common Expression Language (CEL) syntax. For more information on
   * CEL, [see our documentation](https://github.com/bufbuild/protovalidate/blob/main/docs/cel.md).
  ...
  constructor(data?: PartialMessage<PredefinedConstraints>) {
    super();
    proto2.util.initPartial(data, this);
  }

  static readonly runtime: typeof proto2 = proto2;
  static readonly typeName = "buf.validate.PredefinedConstraints";
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    { no: 1, name: "cel", kind: "message", T: Constraint, repeated: true },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): PredefinedConstraints {
    return new PredefinedConstraints().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): PredefinedConstraints {
    return new PredefinedConstraints().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): PredefinedConstraints {
    return new PredefinedConstraints().fromJsonString(jsonString, options);
  }

  static equals(a: PredefinedConstraints | PlainMessage<PredefinedConstraints> | undefined, b: PredefinedConstraints | PlainMessage<PredefinedConstraints> | undefined): boolean {
    return proto2.util.equals(PredefinedConstraints, a, b);
  }
}
 ...
 */
export const message = proto2.makeExtension<MessageOptions, MessageConstraints>(
 ...
 */
export const oneof = proto2.makeExtension<OneofOptions, OneofConstraints>(
  "buf.validate.oneof", 
  OneofOptions, 
 ...
 */
export const field = proto2.makeExtension<FieldOptions, FieldConstraints>(
  "buf.validate.field", 
  FieldOptions, 
 ...
 */
export const predefined = proto2.makeExtension<FieldOptions, PredefinedConstraints>(
