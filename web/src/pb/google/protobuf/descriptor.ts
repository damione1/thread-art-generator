    ...
    export class FieldOptions extends pb_1.Message {
        ...
        toObject() {
            ...
            if (this.edition_defaults != null) {
                data.edition_defaults = this.edition_defaults.map((item: FieldOptions.EditionDefault) => item.toObject());
            }
            if (this.features != null) {
                data.features = this.features.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.edition_defaults.length)
                writer.writeRepeatedMessage(20, this.edition_defaults, (item: FieldOptions.EditionDefault) => item.serialize(writer));
            if (this.has_features)
