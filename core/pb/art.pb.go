...
var file_art_proto_rawDesc = string([]byte{
	...
	0x61, 0x72, 0x74, 0x73, 0x2f, 0x27, 0x29, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x42, 0x24, 0x5a,
...
var file_art_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_art_proto_depIdxs = []int32{
	7, // 0: pb.Art.create_time:type_name -> google.protobuf.Timestamp
	7, // 1: pb.Art.update_time:type_name -> google.protobuf.Timestamp
	0, // 2: pb.CreateArtRequest.art:type_name -> pb.Art
	0, // 3: pb.UpdateArtRequest.art:type_name -> pb.Art
	8, // 4: pb.UpdateArtRequest.update_mask:type_name -> google.protobuf.FieldMask
