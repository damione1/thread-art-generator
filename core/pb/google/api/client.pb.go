...
const file_google_api_client_proto_rawDesc = "" +
	...
	"\fdestinations\x18\x02 \x03(\x0e2$.google.api.ClientLibraryDestinationR\fdestinations\"\x93\x05\n" +
	...
	"\vPhpSettings\x12:\n" +
	"\x06common\x18\x01 \x01(\v2\".google.api.CommonLanguageSettingsR\x06common\"L\n" +
	"\x0ePythonSettings\x12:\n" +
	"\x06common\x18\x01 \x01(\v2\".google.api.CommonLanguageSettingsR\x06common\"J\n" +
	"\fNodeSettings\x12:\n" +
	...
	"\fRubySettings\x12:\n" +
	"\x06common\x18\x01 \x01(\v2\".google.api.CommonLanguageSettingsR\x06common\"H\n" +
	"\n" +
	"GoSettings\x12:\n" +
	"\x06common\x18\x01 \x01(\v2\".google.api.CommonLanguageSettingsR\x06common\"\xc2\x03\n" +
	...
	"\x12total_poll_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x10totalPollTimeout*\xa3\x01\n" +
