...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x02pb\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bbuf/validate/validate.proto\"\xdf\x05\n" +
	"\x04User\x121\n" +
	"\x04name\x18\x01 \x01(\tB\x1d\xe2A\x01\x03\xfaA\x16\n" +
	"\x14art.example.com/UserR\x04name\x12\xcc\x01\n" +
	"\n" +
	"first_name\x18\x03 \x01(\tB\xac\x01\xe2A\x01\x02\xbaH\xa4\x01\xba\x01[\n" +
	"\x16user.first_name.format\x12$First name must contain only letters\x1a\x1bthis.matches(\"^[a-zA-Z]+$\")\xba\x01C\n" +
	"\x18user.first_name.required\x12\x16First name is required\x1a\x0fthis.size() > 0R\tfirstName\x12\xc6\x01\n" +
	"\tlast_name\x18\x04 \x01(\tB\xa8\x01\xe2A\x01\x02\xbaH\xa0\x01\xba\x01Y\n" +
	"\x15user.last_name.format\x12#Last name must contain only letters\x1a\x1bthis.matches(\"^[a-zA-Z]+$\")\xba\x01A\n" +
	"\x17user.last_name.required\x12\x15Last name is required\x1a\x0fthis.size() > 0R\blastName\x12\xc4\x01\n" +
	"\x05email\x18\x05 \x01(\tB\xad\x01\xe2A\x01\x02\xbaH\xa5\x01\xba\x01^\n" +
	"\x11user.email.format\x12\"Please enter a valid email address\x1a%this.matches(\"^[^@]+@[^@]+\\\\.[^@]+$\")\xba\x01A\n" +
	"\x13user.email.required\x12\x19Email address is required\x1a\x0fthis.size() > 0R\x05email\x12\x1c\n" +
	"\x06avatar\x18\a \x01(\tB\x04\xe2A\x01\x03R\x06avatar:'\xeaA$\n" +
	"\x14art.example.com/User\x12\fusers/{user}\"\xce\x01\n" +
	"\x0eGetUserRequest\x12\xbb\x01\n" +
	"\x04name\x18\x01 \x01(\tB\xa6\x01\xe2A\x01\x02\xfaA\x16\n" +
	...
	"\x04user\x18\x01 \x01(\v2\b.pb.UserB\n" +
	"\xe2A\x01\x02\xbaH\x03\xc8\x01\x01R\x04user\"Y\n" +
	...
	"\x11DeleteUserRequest\x12\xbe\x01\n" +
	"\x04name\x18\x01 \x01(\tB\xa9\x01\xe2A\x01\x02\xfaA\x16\n" +
