...
var (
	accountActivationAllColumns            = []string{"id", "user_id", "activation_token", "expiration", "created_at", "user_email"}
	accountActivationColumnsWithoutDefault = []string{"user_id", "activation_token", "user_email"}
