...
type LoginResponse struct {
	...
	AccessTokenExpireTime *timestamp.Timestamp `protobuf:"bytes,5,opt,name=access_token_expire_time,json=accessTokenExpireTime,proto3" json:"access_token_expire_time,omitempty"`
	// RefreshTokenExpiresTime is the refresh token expiration time.
	RefreshTokenExpireTime *timestamp.Timestamp `protobuf:"bytes,6,opt,name=refresh_token_expire_time,json=refreshTokenExpireTime,proto3" json:"refresh_token_expire_time,omitempty"`
}
...
func (x *LoginResponse) GetAccessTokenExpireTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *LoginResponse) GetRefreshTokenExpireTime() *timestamp.Timestamp {
	if x != nil {
...
type RefreshTokenResponse struct {
	...
	// AccessTokenExpiresTime is the access token expiration time.
	AccessTokenExpireTime *timestamp.Timestamp `protobuf:"bytes,3,opt,name=access_token_expire_time,json=accessTokenExpireTime,proto3" json:"access_token_expire_time,omitempty"`
	// RefreshTokenExpiresTime is the refresh token expiration time.
	RefreshTokenExpireTime *timestamp.Timestamp `protobuf:"bytes,4,opt,name=refresh_token_expire_time,json=refreshTokenExpireTime,proto3" json:"refresh_token_expire_time,omitempty"`
}
...
func (x *RefreshTokenResponse) GetAccessTokenExpireTime() *timestamp.Timestamp {
	if x != nil {
		return x.AccessTokenExpireTime
	}
	return nil
...
func (x *RefreshTokenResponse) GetRefreshTokenExpireTime() *timestamp.Timestamp {
	if x != nil {
		return x.RefreshTokenExpireTime
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x42, 0x23, 0x5a, 0x21, 0x74, 0x68, 0x72, 0x65, 0x61,
