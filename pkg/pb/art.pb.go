...
type UploadArtRequest struct {
	...
	Parent string `protobuf:"bytes,1,opt,name=parent,proto3" json:"parent,omitempty"`
	// The name of the art
	ArtName string `protobuf:"bytes,2,opt,name=art_name,json=artName,proto3" json:"art_name,omitempty"` // This is the art name
	// The data of the art
...
func (x *UploadArtRequest) GetParent() string {
	if x != nil {
		return x.Parent
	}
	return ""
...
func (x *UploadArtRequest) GetArtName() string {
	if x != nil {
		return x.ArtName
	}
	return ""
...
var file_art_proto_rawDesc = []byte{
	...
	0x06, 0x70, 0x62, 0x2e, 0x41, 0x72, 0x74, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x59, 0x0a,
	...
	0x09, 0x52, 0x06, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x72, 0x74,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x72, 0x74,
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x23, 0x5a, 0x21, 0x74, 0x68, 0x72, 0x65,
	0x61, 0x64, 0x2d, 0x61, 0x72, 0x74, 0x2d, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72,
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x70, 0x62, 0x62, 0x06, 0x70,
